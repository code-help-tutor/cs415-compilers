...
typedef enum opcode_name {NOP=0, VECTON, VECTOFF, ADD, SUB, MULT, DIV, ADDI, SUBI, MULTI,
			      DIVI, LSHIFT, LSHIFTI, RSHIFT, RSHIFTI,
			      AND, OR, XOR,  /* Added April 17th, 2007 by John McCabe */
			      ...
			      OUTPUT, COUTPUT, OUTPUTAI} Opcode_Name;
